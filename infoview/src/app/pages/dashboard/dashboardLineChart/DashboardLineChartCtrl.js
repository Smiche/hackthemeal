...
(function () {
  ...
  /** @ngInject */
  function DashboardLineChartCtrl(baConfig, layoutPaths, baUtil, $rootScope, ReportTemplateService) {
    ...
    function initChart() {
      ...
      var data = ReportTemplateService.GetLineData();
      var chartArr = [];
      for(var key in data){
        chartArr.push(
          {
            ...
            value0:data[key].value0,
            value1:data[key].value1
          });
      }

      var chartData = chartArr;
      /*[
